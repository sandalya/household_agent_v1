...
Збережи: відкриті питання, незавершені діалоги, контекст кулінарних обговорень, побутові рішення, уподобання сім'ї.

НЕ включай: конкретні назви продуктів з шоп-ліста/інвентаря/морозилки, операції додавання/видалення/оновлення цих списків, результати команд /list. Актуальний стан цих списків завжди є у системному промпті — дублювати в summary НЕ ТРЕБА, це породжує плутанину з кількостями.

Викидай: привітання, короткі підтвердження ("ок", "дякую"), tool-результати.

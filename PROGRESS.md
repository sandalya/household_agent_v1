...
### Фаза 5 — Інтеграція з заказ.юа + Розумний Metro (В ПРОЦЕСІ)
...
- Коментарі до товарів в кошику для вагових товарів (add_to_cart + pick_best_product)
- Логіка "розумної заміни" — Мег пропонує вигідніший варіант якщо є (список = пріоритет, але не догма)
...
- Збагатити zakaz_lists.json назвами товарів і налаштувати match по EAN
- Коментарі до товарів в кошику для вагових товарів (add_to_cart + pick_best_product)
- Логіка "розумної заміни" — Мег пропонує вигідніший варіант якщо є

...
* Профілі сім'ї: заповнено (Саша, Ксюша, Сашулік)
...
* **Масштабування** — "зроби на 2кг м'яса" → Claude рахує коефіцієнт
...
### Фаза 2 — залишилось
* **"З'їли X з ящика Y"** — розширити remove_from_freezer з кількістю
* `/recipes` — команда перегляду збережених рецептів
...
* При оновленні PROGRESS.md — писати через python скрипт в /tmp, не через cat heredoc
